<template>
  ...
  <view class="pages">
    <block>
      ...
      <view
        v-if="huigou_status >= 2 && huigou_status != 3 && huigou_status != 6"
      >
        <view class="cell-group">
          <view class="blod"> 卖家已经同意回购，请把商品回寄到以下地址： </view>
          <lk-cell
    ...
    onSubmit() {
      ...
      SUB_HUIGOUEXPRESS(params)
        .then(res => {
          ...
          this.refund_detail.huigou_back_company_name =
            this.huigou_back_company_name;
          this.refund_detail.huigou_back_shipping_code =
            this.huigou_back_shipping_code;
