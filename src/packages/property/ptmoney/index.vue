<template>
  ...
  <view class="pages">
	   ...
	   <view style="text-align:center;margin:30rpx 0;">
		   <view>累计获得</view>
		  <view style="font-size:70rpx;margin:20rpx 0;">{{info.pt_moeny_all || 0}}</view>
	      <!-- <lk-button
	        size="small"
	        round
	        plain
	...
	>
	  ...
	  <lk-tab>
	    <text style="font-size:24rpx;">其他积分({{info.pt_moeny_my || 0}})</text>
	  </lk-tab>
    <lk-tab>
      <text style="font-size:24rpx;">已结积分({{info.total_commission_pv || 0}})</text>
    </lk-tab>
	  <lk-tab >
	    <text style="font-size:24rpx;">未发积分({{info.frozen_commission_pv || 0}})</text>
	  </lk-tab>
...
<script>
	...
	import { GET_ASSETACCOUNT,GET_ASSETACCOUNTMONTH } from "@/common/interface/property";
