  ...
  <view class="footer-tab">
    ...
    <view class="tabbar">
      ...
      <view
        ...
        :style="active == 1 ? 'color:' + theme.color : ''"
        @click="click(1)"
      >
...
export default {
  ...
  methods: {
    click(i) {
      ...
      let paths = [
        "/packages/shop/home?shop_id="+this.shopid,
        "/packages/shop/category?shop_id="+this.shopid,
        "/packages/shop/member?shop_id="+this.shopid,
      ];
      if (this.active != i) {
