export default {
  ...
  'packages-property-index': {
    path: '/packages/property/index',
    name: 'packages-property-index',
    alias: ['/packages/centre', 'packages/property/myProperty/index'],
    meta: {
      name: 'packages-property-index',
      isNVue: false,
      pagePath: 'packages/property/index',
      windowTop: 44,
      possTabBar: true,
    },
    title: '我的资产',
  ...
  'packages-coupon-index': {
    path: '/packages/coupon/index',
    name: 'packages-coupon-index',
    alias: ['/packages/centre', 'packages/coupon/centre/index'],
    meta: {
      name: 'packages-coupon-index',
      isNVue: false,
      pagePath: 'packages/coupon/index',
      windowTop: 44,
      possTabBar: true,
      noLogin: true,
      shareType: 'current',
  ...
  'packages-task-index': {
    path: '/packages/task/index',
    name: 'packages-task-index',
    alias: ['/packages/centre', 'packages/task/centre/index'],
    meta: {
      name: 'packages-task-index',
      isNVue: false,
      pagePath: 'packages/task/index',
      windowTop: 44,
      possTabBar: true,
      shareType: 'current',
      addon: 'taskcenter',
